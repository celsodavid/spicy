...
function enviar_email($nome, $email, $telefone, $mensagens, $site, $CCopia) {
    ...
    $config = array(
        ...
        'charset' => 'utf8',
        'wordwrap' => TRUE,
        'smtp_host' => 'mail.patrianispettacolo.com.br',
        'smtp_user' => 'contato@patrianispettacolo.com.br',
        'smtp_pass' => 'patriani@123',
    	'smtp_port' => 587,
        'smtp_timeout' => 20,
        'mailtype' => 'html'
    );
    ...
    $CI->email->to('contato@patrianispettacolo.com.br');    
    $CI->email->cc($CCopia);
